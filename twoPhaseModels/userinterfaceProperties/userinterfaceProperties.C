...
#include "userinterfaceProperties.H"
#include "alphaContactAngleFvPatchScalarField.H"
#include "unitConversion.H"
#include "surfaceInterpolate.H"
//#include "fvcAverage.H"								/*For function method involving fvc::average*/
#include "fvcDiv.H"
#include "fvcGrad.H"
#include "fvcSnGrad.H"
#include "smooth_function.H"						/*For loop method*/
...
void Foam::userinterfaceProperties::correctContactAngle
(
...
void Foam::userinterfaceProperties::calculateK()
{
    const fvMesh& mesh = alpha1_.mesh();
    const surfaceVectorField& Sf = mesh.Sf();
	
	// Loop method for alpha smoothening
	volScalarField alpha1_smooth = alpha1_;
	smoothen(alpha1_smooth);
	
	/*// Function method for alpha smoothening
	volScalarField alpha1_smooth(fvc::average(fvc::interpolate(alpha1_)));*/
...
Foam::userinterfaceProperties::userinterfaceProperties
(
...
Foam::userinterfaceProperties::sigmaK() const
{
...
Foam::userinterfaceProperties::surfaceTensionForce() const
{
...
Foam::tmp<Foam::volScalarField>
Foam::userinterfaceProperties::nearInterface() const
{
    return pos0(alpha1_ - 0.01)*pos0(0.99 - alpha1_);
}


void Foam::userinterfaceProperties::correct()
{
    calculateK();
}


bool Foam::userinterfaceProperties::read()
{
